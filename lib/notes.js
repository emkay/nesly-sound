...
Notes.prototype.fadeIn = function fadeIn() {
    this.volumeEnvelope('ve_fade_in');
    return this;
};
...
Notes.prototype.volOn = function volOn() {
    this.volumeEnvelope('ve_on');
    return this;
};

Notes.prototype.volOff = function volOff() {
    this.volumeEnvelope('ve_off');
    return this;
};
...
function normalize(notes) {
    var notes = notes.map(function (note) {
        if (note && note.letter) {
